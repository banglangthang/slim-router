...
const PROVIDER_NAME = "slim-router";
...
// Detect slim-router by base_url containing localhost/127.0.0.1 or matching tunnel URL
const hasSlim RouterConfig = (modelCfg) => {
...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      installed: true,
      settings: { model },
      hasSlim Router: hasSlim RouterConfig(model),
