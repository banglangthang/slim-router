...
const OAUTH_TEST_CONFIG = {
  ...
  github: {
    ...
    authHeader: "Authorization",
    authPrefix: "Bearer ",
    extraHeaders: { "User-Agent": "Slim Router", "Accept": "application/vnd.github+json" },
  },
  iflow: {
...
export async function testSingleConnection(id) {
  ...
  const effectiveProxy = {
    ...
    connectionProxyUrl: connection.providerSpecificData?.connectionProxyUrl || null,
    connectionNoProxy: connection.providerSpecificData?.connectionNoProxy || null,
    vercelRelayUrl: connection.providerSpecificData?.vercelRelayUrl || null,
  };
