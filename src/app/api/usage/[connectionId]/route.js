...
function resolveConnectionProxyConfig(providerSpecificData) {
  return {
    connectionProxyEnabled: providerSpecificData?.connectionProxyEnabled === true,
    connectionProxyUrl: providerSpecificData?.connectionProxyUrl || null,
    connectionNoProxy: providerSpecificData?.connectionNoProxy || null,
    vercelRelayUrl: providerSpecificData?.vercelRelayUrl || null,
  };
}
